...
// ── Only the login response needs to work correctly for wholesale users.
// ── No logic changes needed — the role is returned as-is from the DB.
// ── The frontend dashboardByRole() in LandingPage.jsx handles the redirect.
// ── This file is unchanged from your original — included here for completeness.
...
export {
  login, googleLogin, forgotPassword,
  validateResetToken, resetPassword, logout, refreshToken,
};
