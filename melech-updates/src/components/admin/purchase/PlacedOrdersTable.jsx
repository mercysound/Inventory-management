        ...
        <table className="min-w-full text-sm text-gray-700 border-collapse">
          <thead className="bg-gray-100 uppercase font-semibold text-gray-600 text-xs">
            <tr>
              ...
              <th className="p-3 text-left cursor-pointer hover:bg-gray-200" onClick={() => onSort("buyerName")}>
                Buyer <SortIcon field="buyerName" sortField={sortField} sortDir={sortDir} />
              </th>
              <th className="p-3 text-left">User</th>
              <th className="p-3 text-left">Products</th>
              <th className="p-3 text-left cursor-pointer hover:bg-gray-200" onClick={() => onSort("totalPrice")}>
                Total <SortIcon field="totalPrice" sortField={sortField} sortDir={sortDir} />
              </th>
              <th className="p-3 text-left">Payment</th>
              <th className="p-3 text-left">Status</th>
              <th className="p-3 text-left cursor-pointer hover:bg-gray-200" onClick={() => onSort("createdAt")}>
            ...
            {orders.map((order, i) => (
              <React.Fragment key={order._id}>
                ...
                >
                  ...
                  <td className="p-3 font-semibold text-green-700">₦{order.totalPrice?.toLocaleString() || 0}</td>
...
export default React.memo(PlacedOrdersTable);
