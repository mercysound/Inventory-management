            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                ...
                <button onClick={handleClosePreview}
                  className="text-gray-400 hover:text-gray-600 text-xl leading-none transition">×</button>
              </div>
              <div className="h-[60vh]">
                {previewUrl
                  ? <iframe src={previewUrl} title="Invoice Preview" className="w-full h-full border-0" />
