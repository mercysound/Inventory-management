...
export default function AddUserPanel({ onSuccess }) {
  ...
  const roleDesc = {
    ...
    customer: "🛍 Standard access — can browse products and place orders.",
  };
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="aup-field">
              ...
              <div className="aup-pw-wrap">
                ...
                <button type="button" onClick={()=>setShowPw(p=>!p)} className="aup-pw-eye" aria-label={showPw?"Hide":"Show"}>
                  {showPw?"🙈":"👁"}
                </button>
              </div>
            ...
            <div className="aup-grid">
              ...
              <div className="aup-field">
                ...
                <select value={form.role} onChange={e=>set("role",e.target.value)} className={`aup-input${errors.role?" aup-input-err":""}`}>
